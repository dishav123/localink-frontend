                ...
                <nav aria-label="Main navigation">
                    <ul className="flex items-start gap-6 font-medium text-[16px]">
                        ...
                        >
                            ...
                            <hr className="border-none outline-none h-[3px] w-3/5 m-auto bg-[#F3752B] scale-x-0 group-hover:scale-x-100 transition-transform duration-300 rounded" aria-hidden="true" />
                        </NavLink>
